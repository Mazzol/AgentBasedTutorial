...
class Schelling:
    ...
    #The is_unsatisfied method takes the (x, y) coordinates of a house as arguments,
    # checks the ratio of neighbors of similar color,
    #  and returns True if the ratio is above the happiness threshold,
    ...
    #The update method checks if each person in the grid is unsatisfied,
    ...
    #The move_to_empty method takes the (x, y) coordinates of a house as arguments, and moves the person living in the (x, y) house to an empty house.
    ...
    #The plot method is used to draw the whole city and people living in the city.
    #  We can call this method at anytime to check the distribution of people in the city.
    #  This method takes two arguments, title and file_name.
...
schelling_P = Schelling(50, 50, 0.3, 0.8, 500, 2)
schelling_P.populate()
...
schelling_P.plot('Schelling Model with 2 colors: Final State with Similarity Threshold 75%', 'schelling_2_80_final.png')
